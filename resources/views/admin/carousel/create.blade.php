@extends('admin.layouts.layout', ['title' => 'Создание элемента карусели'])
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-header blue accent-1">
                                <h3><i class="fa-solid fas fa-box"></i> Добавить элемент карусели:</h3>
                            </div>
                            <form role="form" method="post" action="{{ route('carousel.store') }}" enctype="multipart/form-data">
                            @csrf
