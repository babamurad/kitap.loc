@extends('admin.layouts.layout', ['title' => 'Сообщения в архиве'])
@section('content')
    <!-- Heading & Date -->
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <div class="row">
                            <form action="{{ route('go.archive', $feedback->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <input name="flag" type="text" hidden value="0">
                            <button type="submit" class="btn btn-amber btn-sm" onclick="return confirm('Восстановить из архива?')">
                                <i class="fas fa-archive mr-2"></i>Восстановить
                                </button>
                            </form>
