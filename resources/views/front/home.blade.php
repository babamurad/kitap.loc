...
<!-- Contacts -->
<h2 id="contact" class="h2-responsive text-center font-weight-bold text-center my-4 pt-4 about text-uppercase">Свяжитесь с нами</h2>
<p class="text-center w-responsive mx-auto mb-5">У Вас остались вопросы? Задайте свой вопрос заполнив форму снизу,

    наша команда ответит Вам в ближайшее время.</p>
        <div class="row">
            <!--Grid column-->
    
            <div class="col-md-9 mb-md-0 mb-5 wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
              ...
              @csrf
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="md-form mb-0">
                      ...
                      <label for="validationCustom012" class="">Ваше имя</label>
                ...
                <div class="text-center text-md-left">          
                  <button class="btn btn-rounded btn-orange-2 white-text btn-send waves-effect waves-light" type="submit">Отправить</button>
                </div>            
            ...
            <div class="col-md-4 col-lg-3 wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
              ...
              <ul class="text-center list-unstyled float-md-right">
                ...
                <li>
                  ...
                  <p>744036, Туркменистан, г. Ашгабат, ул Б. Сапармырата Туркменбаши шаелы, д.124, 4 этаж, 201 офис</p>
                ...
                <li>
                  ...
                  <p><a href="tel: +99312468851">(99312) 46-88-51</a></p> 
                  <p>Телефон руководства:</p>
                  <p><a href="tel: +99312468835"> (99312) 46-88-35</a></p>
                </li>
